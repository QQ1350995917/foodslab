...
function getVerticalTabItems() {
    ...
    VerticalTabItems.push(new TabItem("1","系统管理","verticalNormal","verticalSelected","verticalSelected","verticalNormalArrow","verticalSelectedArrow","verticalSelectedArrow"));
